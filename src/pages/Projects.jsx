  ...
  const projects = [
    {
      ...
      keywords: ["Arduino Uno", "Motor Driver Shield", "Bluetooth Module", "Ultrasonic and IR Sensors", "Servo and TT Gear Motors"],
      description:
    ...
    },
    {
      ...
      title: "QuizMaster",
      image: "/quiz.png",
      features: ["Custom Quiz Creation", "AI-Generated Quiz Topics", "Pre-Made Quizzes", "Performance Tracking Dashboard"],
    ...
    },
    {
      ...
      image: "/memory.png",
      features: ["Card Matching Gameplay", "Firebase Authentication", "Real-Time Score Tracking", "High Score Leaderboard"],
    ...
    },
    {
      ...
      image: "/p5.png",
      features: ["A lot of Home Made Food Items and Categories", "Add Cart System of Food", "Details of All Food and Categories", "Food Order Send"],
    ...
    },
    {
      ...
      image: "/p6.png",
      features: ["Simple Rock Paper Scissors Game", "Account Login & Creating System by Firebase", "Save Game Scores to Account"],
    ...
    },
    {
      ...
      features: ["Home Page and Nav Menu", "Natural Photo Gallery", "Macro Photo Gallery", "Night & Astro Photo Gallery", "Web to Android Apps Converter"],
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <h1 className={`text-4xl font-bold ${darkMode ? "text-white" : "text-gray-900"} mb-4`}>My Projects</h1>
        <p className="text-lg max-w-2xl mx-auto">
          Explore my portfolio of web development and engineering projects. Each project showcases different skills and
          technologies.
        </p>
      </div>
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="flex justify-between items-center">
                ...
                >
                  {activeProject === project.id ? "Hide" : "Details"}
                </button>
                ...
                <div className="p-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      ...
                      <h3 className="text-xl font-semibold mt-6 mb-4 text-cyan-500">
